...
namespace pixkit{
	...
	//namespace enhancement{
		...
		namespace enhancement_local{
			...
			bool	MSRCP2014(const cv::Mat &src, cv::Mat &dst, int Scl1 = 7, int Scl2 = 81, int Scl3 = 241, float lPer=0.01, float uPer=0.01);
			// boraN ends
		...
		/// Global methods
		//namespace global{
		namespace enhancement_global{
/// boraN begin
			//bool	RajuNair2014(const cv::Mat &src,cv::Mat &dst);
			bool	RajuNair2014(const cv::Mat &src, cv::Mat &dst, float K = 128.0, float E=255.0);
// boraN end
