...
bool SimplestColorBalance2(cv::Mat ori,float upperthresh,float lowerthresh){
...
bool pixkit::enhancement_local::NRCIR2009( cv::Mat ori,cv::Mat &ret){
	...
	SimplestColorBalance2(E4_Result,0.01,0);
	...
	SimplestColorBalance2(Final_Lab_In[0],0.01,0);
